        ...
        <div class="content_container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card h-100 custom-card rounded shadow" style="position: relative;">
                        ...
                        <div class="card-img-overlay text-center">
                            ...
                            <p class="card-text text-white">Ofrecemos soluciones de alta calidad para tus necesidades
                                técnicas.
                            </p>
                ...
                <div class="col-12 col-md-3">
                    <div class="card shadow mb-5 mb-md-5">
                        <div class="position-relative">
                            <img src="{{ asset('img/televisor.jpg') }}" class="card-img-top pt-3"
                ...
                <div class="col-12 col-md-3">
                    <div class="card shadow mb-5 mb-md-5">
                        <div class="position-relative">
                            <img src="{{ asset('img/estufa.png') }}" class="card-img-top pt-3" alt="Servicio-estufa">
                            <div class="overlay">
                                <i class="fas fa-play fa-3x cursor-pointer" data-bs-toggle="modal"
                ...
                <div class="col-12 col-md-3">
                    <div class="card shadow mb-5 mb-md-5">
                        <div class="position-relative">
                            <img src="{{ asset('img/lavavajilla.jpg') }}" class="card-img-top pt-3"
